...
<div class="container mt-5">
            ...
            <div class="card h-100">
                <div class="card-header bg-primary text-white">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-tasks"></i> Proyectos en Ejecución
                    </h5>
                </div>
                <div class="card-body">
    ...
    <div class="card">
        <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
            <span><i class="fas fa-list"></i> Lista de Proyectos en Ejecución</span>
            <div>
                <a href="{{ route('reports.inProgress', array_merge(request()->all(), ['export' => 'excel'])) }}" class="btn btn-success btn-sm me-2"><i class="fas fa-file-excel"></i> Excel</a>
                <a href="{{ route('reports.inProgress', array_merge(request()->all(), ['export' => 'pdf'])) }}" class="btn btn-danger btn-sm"><i class="fas fa-file-pdf"></i> PDF</a>
            </div>
        </div>
        <div class="card-body">
